-- FitPlatform Manual Database Setup
...
-- ==============================================================================
-- STEP 3: CREATE SUBSCRIPTION MANAGEMENT TABLE
-- ==============================================================================
...
-- ==============================================================================
-- STEP 4: CREATE AUTHENTICATION TOKENS TABLE
-- ==============================================================================
...
CREATE POLICY "Users can access own auth tokens" ON public.auth_tokens
  FOR ALL USING (auth.uid() = user_id);
...
CREATE INDEX IF NOT EXISTS idx_users_is_trainer ON public.users(is_trainer);
...
-- You can now test your authentication system.